# Launches the raspitank in Gazebo to be controlled using a joystick. There are a number of launch arguments that can be toggled.
...
def generate_launch_description():
    ...
    pkg_path = FindPackageShare(
        package='raspitank_gazebo').find('raspitank_gazebo')
    pkg_description = FindPackageShare(
        package='raspitank_description').find('raspitank_description')
    pkg_teleop = FindPackageShare(
        package='raspitank_teleop').find('raspitank_teleop')
    pkg_gazebo_ros = FindPackageShare(package='gazebo_ros').find('gazebo_ros')
    pkg_navigation = FindPackageShare(
        package='raspitank_navigation').find('raspitank_navigation')
